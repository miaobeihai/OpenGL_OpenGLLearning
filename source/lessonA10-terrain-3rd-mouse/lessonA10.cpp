...
public:
    ...
    */
    ...
    virtual void    onInitGL()
    {
        ...
        _terrain.loadHeight("D:\\srtm\\ASTGTM2_N29W100\\ASTGTM2_N29W100\\ASTGTM2_N29W100_dem.tif",0);
...
//         }
        ...
        float   height  =   _terrain.calcHeight(_rolePos.x,_rolePos.z,_terrain._data) + 5;
        _rolePos.y  =   height;
...

        {
            ...
            //! 产生一个矩阵
            glTranslatef(_moveTo.x,_moveTo.y + 10 ,_moveTo.z);
        ...
        case WM_LBUTTONDOWN:
            {
                ...
                float3      dir     =   normalize(c - float3(_rolePos.x,0,_rolePos.z));
