...
namespace CELL
{
    ...
    */
    ...
    template <typename T>
        ...
        template <typename T>
        typename tvec3<T>::value_type length2(tvec3<T> const & v)
        {
    ...
    public:
        ...
        tquat<T>    makeRot(tvec3<T> from,tvec3<T> to)
        {
            tvec3<T> sourceVector = from;
            tvec3<T> targetVector = to;

            T fromLen2 = length2(from);
            T fromLen;
            ...
            else
            {
                ...
                tvec3<T>    tmp =   cross(sourceVector , targetVector) / (2.0f* s );
                x = tmp.x();
                y = tmp.y();
                z = tmp.z();
                w = s;
